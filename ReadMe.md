...
Sample_03_10のプログラムのPlayerクラスは、これまでのポリシーに違反しているため、Enemyの前方宣言が利用できず、Enemyのヘッダーファイルのインクルードが行われています。これをポリシーに従う形に修正して前方宣言を利用できるようにしてください。なお、解答例としてenemy.after.h、enemy.after.cppが用意されています。
